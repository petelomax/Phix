...
0000034B,0040114B:  mov ecx,#0040202C,-,271 2C204000,vu 02 00  1  93      -- "UNDEFINED VARIABLE %d"
...
0000035D,0040115D:  add eax,12,-,203300 0C,uv 01 01  1  97              -- e->term
...
0000036B,0040116B:  add eax,4,-,203300 04,uv 01 01  1 102               -- e->envp
0000036E,0040116E:  mov ecx,[eax],-,213010,uv 02 01  1 105 01 *01*
00000370,00401170:  add ecx,8,-,203301 08,uv 02 02  1 106 02   
00000373,00401173:  mov eax,[ecx],-,213001,uv 01 02  1 109 02 *02*      -- e_>envp->refs
00000375,00401175:  add eax,1,-,203300 01,uv 01 01  1 110 01   
00000378,00401178:  mov [ecx],eax,-,211001,uv 00 03  1 111 01           -- e->envp->refs += 1
