NEEDS REWORKING:
error handling all wrong
should be re-entrant, fast due to integer-only results
--X while this contains the include stack, p2main.e is wholly responsible for all things when-related. -- p2inc.e
