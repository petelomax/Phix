...
--/* Not Phix (defined in auto_include builtins/pbreak.e)
...
sequence ca
    ...
    if fgbg then
        ca = ca[1] & and_bits(ca[2], 0x0F) & and_bits(ca[2]/16, 0x0F)
    end if
...
integer fgbg1 = and_bits(attr_code, 0x0F)
integer fgbg2 = and_bits(attr_code/16, 0x0F)
    return {find(fgbg1,true_fgcolor)-1, find(fgbg2,true_bgcolor)-1}
end function
...
--/* Not Phix (defined in pfileioN.e)
