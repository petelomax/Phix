...
--/**/      if sequence(char_set[1]) then
--/**/          for j = 1 to length(char_set) do
--/**/              if lChr >= char_set[j][1] and lChr <= char_set[j][2] then skip = 1 exit end if
--/**/          end for
--/**/      else
--/**/          if find(lChr, char_set) > 0 then skip = 1 exit end if
--/**/      end if
--/**/      if skip then skip = 0 else return FALSE end if
--/**/  end for
--/*
