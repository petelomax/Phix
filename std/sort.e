...
--Phix: defined in builtins\sort.e
--/*
...
--DEV Phix: incompatible with sort.e's custom_sort... (fixable as rqd)
--/*
...
--/**/          if compare(s[i], key) <= 0 then exit end if
--/**/          a = i
--/**/      end for
--/**/      if a != j then
--/**/          s[a+1 .. j] = s[a .. j-1]
...
--/**/      a = j
--/**/      for i = j - 1 to 1 by -1 do
--/**/          if call_func(compfunc,{s[i], key, userdata}) <= 0 then exit end if
--/**/          a = i
--/**/      end for
--/**/      if a != j then
--/**/          s[a+1 .. j] = s[a .. j-1]
