...
global constant phixversion = {1,0,4},  -- 1.0.4    -- 23/12/23
...
--global integer T_long = 0,
--             T_ulong = 0,
--             T_ptr = 0
global integer T_ptr = 0,
               Z_int = 0,           -- (T_int already in use by pttree.e/pilasm.e)
               T_uint = 0,
               T_int64 = 0,
               T_uint64 = 0,
               T_win32 = 0,
               ...
               T_AStr = 0,
               T_ASeq = 0,
               T_compare = 0,       -- map "if compare(a,b)<relop>-1/0/1" to "if a<relop>b"
--             T_find = 0,          -- for defaulting 3rd param to 1
               T_find = 0,          -- for enum type
...
--             T_get_text = 0,      -- for defaulting 2nd param to -2
               ...
               T_floor_div = 0,     -- ""
               T_sqfloor = 0,       -- map "floor(p/s)" to sq_floor(p,s)
               T_sqfloor_div = 0,   -- ""
--             T_malloc = 0,
--             T_mfree = 0,
               T_routine = 0,
...
--             T_call_func = 0,
--             T_dcproc = 0,        -- map define_c_proc(l,n,a) to define_c_func(l,n,a,0)
               T_command_line = 0,  -- (for parameter defaulting)
               Z_command_line = 0,  -- (1 iff needs linking for parameter defaulting)
               T_SLASH = 0,
               T_platform = 0,
               T_machine_bits = 0,
               T_machine_word = 0,
