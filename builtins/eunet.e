...
atom wsastatus, wsadata
    ...
    if platform()=WINDOWS then
        ...
        getiftable_ = define_c_func(ipdll_,"GetAdaptersInfo",{C_PTR,C_PTR},C_LONG)
        bind_ = define_c_func(sockdll_,"bind",{C_INT,C_PTR,C_INT},C_INT)
        connect_ = define_c_func(sockdll_,"connect",{C_INT,C_PTR,C_INT},C_INT)
        poll_ = define_c_func(sockdll_,"WSAPoll",{C_PTR,C_INT,C_INT},C_INT)
        listen_ = define_c_func(sockdll_,"listen",{C_INT,C_INT},C_INT)
--      accept_ = define_c_func(sockdll_,"accept",{C_INT,C_PTR,C_PTR},C_INT)
        accept_ = define_c_func(sockdll_,"WSAAccept",{C_INT,C_PTR,C_PTR,C_PTR,C_INT},C_INT)
        socket_ = define_c_func(sockdll_,"socket",{C_INT,C_INT,C_INT},C_INT)
        ioctl_ = define_c_func(sockdll_,"ioctlsocket",{C_INT,C_INT,C_PTR},C_INT)
        getsockopts_ = define_c_func(sockdll_,"getsockopt",{C_INT,C_INT,C_INT,C_PTR,C_PTR},C_INT)
        setsockopts_ = define_c_func(sockdll_,"setsockopt",{C_INT,C_INT,C_INT,C_PTR,C_INT},C_INT)
        send_ = define_c_func(sockdll_,"send",{C_INT,C_PTR,C_INT,C_INT},C_INT)
        sendto_ = define_c_func(sockdll_,"sendto",{C_INT,C_PTR,C_INT,C_INT,C_PTR,C_INT},C_INT)
        sendmsg_ = define_c_func(sockdll_,"sendmsg",{C_INT,C_PTR,C_INT},C_INT)
        recv_ = define_c_func(sockdll_,"recv",{C_INT,C_PTR,C_INT,C_INT},C_INT)
        recvfrom_ = define_c_func(sockdll_,"recvfrom",{C_INT,C_PTR,C_INT,C_INT,C_PTR,C_PTR},C_INT)
        recvmsg_ = define_c_func(sockdll_,"recvmsg",{C_INT,C_PTR,C_INT},C_INT)
        close_ = define_c_func(sockdll_,"closesocket",{C_INT},C_INT)
        shutdown_ = define_c_func(sockdll_,"shutdown",{C_INT,C_INT},C_INT)
        gethostbyname_ = define_c_func(sockdll_,"gethostbyname",{C_PTR},C_PTR)
        getservbyname_ = define_c_func(sockdll_,"getservbyname",{C_PTR,C_PTR}, C_PTR)
        getaddrinfo_ = define_c_func(sockdll_,"getaddrinfo",{C_PTR,C_PTR,C_PTR,C_PTR},C_INT)
        freeaddrinfo_ = define_c_proc(sockdll_,"freeaddrinfo",{C_PTR})
        -- WSAStartup() is required when using WinSock.
        wsastart_ = define_c_func(sockdll_,"WSAStartup",{C_USHORT,C_PTR},C_INT)
        ...
        wsaenumnetworkevents_ = define_c_func(sockdll_,"WSAEnumNetworkEvents",{C_INT,C_INT,C_PTR},C_INT)
        wsawaitformultipleevents_ = define_c_func(sockdll_,"WSAWaitForMultipleEvents",{C_INT,C_PTR,C_INT,C_INT,C_INT},C_INT)
        delay_ = define_c_proc(kerneldll_,"Sleep",{C_INT})
        dnsquery_ = define_c_func(dnsdll_,"DnsQuery_A",{C_PTR,C_USHORT,C_INT,C_PTR,C_PTR,C_PTR},C_INT)
        dnsrlfree_ = define_c_proc(dnsdll_,"DnsRecordListFree",{C_PTR,C_INT})
        ...
        getsockopts_ = define_c_func(dll_,"getsockopt",{C_INT,C_INT,C_INT,C_PTR,C_PTR},C_INT)
        setsockopts_ = define_c_func(dll_,"setsockopt",{C_INT,C_INT,C_INT,C_PTR,C_INT},C_INT)
        bind_ = define_c_func(dll_,"bind",{C_INT,C_PTR,C_INT},C_INT)
        connect_ = define_c_func(dll_,"connect",{C_INT,C_PTR,C_INT},C_INT)
        poll_ = define_c_func(dll_,"poll",{C_PTR,C_INT,C_INT},C_INT)
        listen_ = define_c_func(dll_,"listen",{C_INT,C_INT},C_INT)
        accept_ = define_c_func(dll_,"accept",{C_INT,C_PTR,C_PTR},C_INT)
        send_ = define_c_func(dll_,"send",{C_INT,C_PTR,C_INT,C_INT},C_INT)
        sendto_ = define_c_func(dll_,"sendto",{C_INT,C_PTR,C_INT,C_INT,C_PTR,C_INT},C_INT)
        sendmsg_ = define_c_func(dll_,"sendmsg",{C_INT,C_PTR,C_INT},C_INT)
        recv_ = define_c_func(dll_,"recv",{C_INT,C_PTR,C_INT,C_INT},C_INT)
        recvfrom_ = define_c_func(dll_,"recvfrom",{C_INT,C_PTR,C_INT,C_INT,C_PTR,C_PTR},C_INT)
        recvmsg_ = define_c_func(dll_,"recvmsg",{C_INT,C_PTR,C_INT},C_INT)
        close_ = define_c_func(dll_,"close",{C_INT},C_INT)
        shutdown_ = define_c_func(dll_,"shutdown",{C_INT,C_INT},C_INT)
        gethostbyname_ = define_c_func(dll_,"gethostbyname",{C_PTR},C_PTR)
        getservbyname_ = define_c_func(dll_,"getservbyname",{C_PTR,C_PTR}, C_PTR)
        getaddrinfo_ = define_c_func(dll_,"getaddrinfo",{C_PTR,C_PTR,C_PTR,C_PTR},C_INT)
        freeaddrinfo_ = define_c_proc(dll_,"freeaddrinfo",{C_PTR})
        delay_ = define_c_func(dll_,"nanosleep",{C_PTR,C_PTR},C_INT)
        dnsquery_ = define_c_func(dnsdll_,"res_query",{C_PTR,C_INT,C_INT,C_PTR,C_INT},C_INT)
        dnsexpand_ = define_c_func(dnsdll_,"dn_expand",{C_PTR,C_PTR,C_PTR,C_PTR,C_INT},C_INT)
    else
        ?9/0
    end if
...
atom iptable, tblptr, getipaddrtable_, status, sz
    ...
    getipaddrtable_ = define_c_func(ipdll_,"GetIpAddrTable",{C_PTR,C_PTR,C_INT},C_INT)
