...
--  "porting from pGUI" entry in the theGUI docs (just text mangling).
-- returns true if the clipboard contains "include pGUI.e" (not theGUI.e)
...
--  {string {cd,g,a}, integer {nc,rc}} = cr
    ...
    -- ==> gDrawRect(?[gdx]canvas,xmin,xmax,ymin,ymax, [bFill,rc:]w,h)
...
function substitute_at(sequence text, idii, object s, r)
    ...
    --      mangling TG_DARK_GREEN (etc): filter(find_all('K_'),?) rqd.
...
global function theGUI_from_pGUI(string src)
    ...
    res = substiqute(res,`"BGCOLOR"`,"`BGCLR`")
    res = substiqute(res,`"FGCOLOR"`,"`FGCLR`")
    res = substiqute(res,`"GRIDCOLOR"`,"`GRIDCLR`")
...
--            {{`to_rgb`,`cdDecodeColorAlpha`,`cdDecodeColor`},`to_rgba`},
              {{`CD_AMBER`,`IUP_AMBER`},`TG_AMBER`},
              {{`CD_BLACK`,`IUP_BLACK`},`TG_BLACK`},
              {{`CD_BLUE`,`IUP_BLUE`},`TG_BLUE`},
              {{`CD_CYAN`,`IUP_CYAN`},`TG_CYAN`},
              {{`CD_DARK_BLUE`,`IUP_DARK_BLUE`,`CD_NAVY`,`IUP_NAVY`},`TG_NAVY`},
              {{`CD_DARK_CYAN`,`IUP_DARK_CYAN`,`CD_TEAL`,`IUP_TEAL`},`TG_TEAL`},
              {{`CD_DARK_GRAY`,`CD_DARK_GREY`,`IUP_DARK_GRAY`,`IUP_DARK_GREY`},`TG_DARK_GREY`},
              {{`CD_GRAY`,`CD_GREY`,`IUP_GRAY`,`IUP_GREY`},`TG_GREY`},
              {{`CD_LIGHT_GRAY`,`CD_LIGHT_GREY`,`IUP_LIGHT_GRAY`,`IUP_LIGHT_GREY`},`TG_LIGHT_GREY`},
              {{`CD_DARK_GREEN`,`IUP_DARK_GREEN`},`TG_DARK_GREEN`},
              {{`CD_DARK_MAGENTA`,`IUP_DARK_MAGENTA`},`TG_DARK_PURPLE`},
              {{`CD_DARK_RED`,`IUP_DARK_RED`},`TG_DARK_RED`},
              {{`CD_DARK_YELLOW`,`IUP_DARK_YELLOW`},`TG_DARK_YELLOW`},
              {{`CD_GREEN`,`IUP_GREEN`},`TG_GREEN`},
              {{`CD_INDIGO`,`IUP_INDIGO`},`TG_INDIGO`},
              {{`CD_LIGHT_BLUE`,`IUP_LIGHT_BLUE`},`TG_LIGHT_BLUE`},
              {{`CD_LIGHT_GREEN`,`IUP_LIGHT_GREEN`},`TG_LIGHT_GREEN`},
              {{`CD_LIGHT_PARCHMENT`,`IUP_LIGHT_PARCHMENT`},`TG_LIGHT_PARCHMENT`},
              {{`CD_MAGENTA`,`IUP_MAGENTA`},`TG_MAGENTA`},
              {{`CD_OLIVE`,`IUP_OLIVE`},`TG_OLIVE`},
              {{`CD_ORANGE`,`IUP_ORANGE`},`TG_ORANGE`},
              {{`CD_PARCHMENT`,`IUP_PARCHMENT`},`TG_PARCHMENT`},
              {{`CD_PURPLE`,`IUP_PURPLE`},`TG_PURPLE`},
              {{`CD_RED`,`IUP_RED`},`TG_RED`},
              {{`CD_SILVER`,`IUP_SILVER`},`TG_SILVER`},
              {{`CD_VIOLET`,`IUP_VIOLET`},`TG_VIOLET`},
              {{`CD_WHITE`,`IUP_WHITE`},`TG_WHITE`},
              {{`CD_YELLOW`,`IUP_YELLOW`},`TG_YELLOW`},
...
--??          {{`IupNormaliser(`,`IupNormalizer(`},`;gNormalise(""[?=NORMALIZE],`},
    ...
    -- all 1:1 mappings:
    for s in {{`cdCanvasArc`,`gDrawArc`},
              {`cdCanvasChord`,`gDrawArc[with flags|=TG_CHORD]`},
              {`cdCanvasCircle`,`gDrawCircle`},
              {`cdCanvasSector`,`gDrawArc[with flags|=TG_SECTOR]`},
              {`cdCanvasBox`,`gDrawRect[filled:=true]`},
              ...
              {`CD_BASE_CENTER`,`TG_SOUTH`},
              {`CD_BASE_LEFT`,`TG_SOUTHWEST`},
              {`CD_BASE_RIGHT`,`TG_SOUTHEAST`},
--            {`CD_CENTER`,`0`},
              {`CD_CENTER`,`TG_CENTRE`},
              {`CD_EAST`,`TG_EAST`},
              {`CD_NORTH`,`TG_NORTH`},
              {`CD_NORTH_EAST`,`TG_NORTHEAST`},
              {`CD_NORTH_WEST`,`TG_NORTHWEST`},
              {`CD_SOUTH`,`TG_SOUTH`},
              {`CD_SOUTH_EAST`,`TG_SOUTHEAST`},
              {`CD_SOUTH_WEST`,`TG_SOUTHWEST`},
              {`CD_WEST`,`TG_WEST`},
...
--            {`IupMenu`,`gMenu`},  -- not worth it...
    ...
    for comma_rep in {{{`cdCanvasRoundedBox(`,`gDrawRect(?[gdx]`,`, [bFill(true), rc(*2):]`},{6,5}}} do
...
--  end for
    res = substiqute(res,`"KEY_CB"`,"`KEY`")
    res = substitute(res,`IUP_`,`TG_`)
--oops, TG_DARK_GREEN -> TG_DARVK_GREEN... (and a few others, eg CLICK_CB)
--  res = substitute(res,`TG_DARK_`,`TG_DAKR_`)
--  res = substitute(res,`K_`,`VK_`)
--  res = substitute(res,`TG_DAKR_`,`TG_DARK_`)
...
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:677 local constant key_mappings = {{"VK_BS",      VK_BS       := #08,     #08, #FF08}, -- aka '\b'
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:678                                  {"VK_TAB",       VK_TAB      := #09,     #09, #FF09}, -- aka '\t'
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:680                                  {"VK_LF",        VK_LF       := #0A,     #0A, #FF0A}, -- aka '\n'
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:682                                  {"VK_PAUSE",     VK_PAUSE    := #13,     #13, #FF13}, -- (GTK3+ only, not GTK2)
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:683                                  {"VK_CAPSLOCK",  VK_CAPSLOCK := #14,     #14, #0000}, -- (not GTK)
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:686                                  {"VK_LCTRL",     VK_LCTRL    := #17,     #1D, #FFE3},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:687                                  {"VK_RCTRL",     VK_RCTRL    := #18,    #11D, #FFE4},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:688                                  {"VK_LALT",      VK_LALT     := #19,   #2038, #FFE9},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:689                                  {"VK_RALT",      VK_RALT     := #1A,   #2138, #FFEA},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:694                                  {"VK_NUMLOCK",   VK_NUMLOCK  := #90,     #90, #FF7F},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:700                                  {"VK_APPS",      VK_APPS     := #E0,     #5D, #FF67},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:701                                  {"VK_INS",       VK_INS      := #E1,     #2D, #FF63},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:702                                  {"VK_SCROLL",    VK_SCROLL   := #E2,     #91, #FF14},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:703                                  {"VK_PGUP",      VK_PGUP     := #E4,     #21, #FF55},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:704                                  {"VK_PGDN",      VK_PGDN     := #E5,     #22, #FF56},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:705                                  {"VK_END",       VK_END      := #E6,     #23, #FF57},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:706                                  {"VK_HOME",      VK_HOME     := #E7,     #24, #FF50},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:717                                  {"VK_APPS",      VK_APPS     := #E0,     #5D, #FF67},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:718                                  {"VK_INS",       VK_INS      := #E1,     #2D, #FF63},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:719                                  {"VK_HOME",      VK_HOME     := #E2,     #24, #FF50},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:720                                  {"VK_END",       VK_END      := #E3,     #23, #FF57},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:721                                  {"VK_PGUP",      VK_PGUP     := #E4,     #21, #FF55},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:722                                  {"VK_PGDN",      VK_PGDN     := #E5,     #22, #FF56},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:723                                  {"VK_NUMLOCK",   VK_NUMLOCK  := #90,     #90, #FF7F},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:724                                  {"VK_SCROLL",    VK_SCROLL   := #E6,     #91, #FF14},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:742                                  {"VK_F3",        VK_F3       := #F3,     #72, #FFC0},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:743                                  {"VK_F4",        VK_F4       := #F4,     #73, #FFC1},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:745                                  {"VK_F6",        VK_F6       := #F6,     #75, #FFC3},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:746                                  {"VK_F7",        VK_F7       := #F7,     #76, #FFC4},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:747                                  {"VK_F8",        VK_F8       := #F8,     #77, #FFC5},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:748                                  {"VK_F9",        VK_F9       := #F9,     #78, #FFC6},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:749                                  {"VK_F10",       VK_F10      := #FA,     #79, #FFC7},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:750                                  {"VK_F11",       VK_F11      := #FB,     #7A, #FFC8},
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:751                                  {"VK_F12",       VK_F12      := #FC,     #7B, #FFC9}}
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:5860       if ctrl or (not bGraphic and wParam!=VK_SP) then
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:5869 --        if wParam!=VK_BS then
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:5892   if wParam=VK_TAB then
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:6783 --                       (msg=WM_CHAR and wParam=VK_RETURN)) then
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:6785   elsif (msg=WM_CHAR and id=TREE1 and wParam=VK_RETURN)
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:12820           pg = (c=VK_PGUP or c=VK_PGDN),
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:12834       case VK_PGUP:           origy -= step
C:\Program Files (x86)\Phix\demo\theGUI\theGUI.e:12835       case VK_PGDN:           origy += step
