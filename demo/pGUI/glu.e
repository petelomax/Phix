...
global constant
xgluBeginPolygon        = define_c_proc(glu32,"gluBeginPolygon",{GLUtesselatorPtr}),
xgluBeginSurface        = define_c_proc(glu32,"gluBeginSurface",{GLUnurbsPtr}),
xgluBeginTrim           = define_c_proc(glu32,"gluBeginTrim",{GLUnurbsPtr}),
xgluBuild2DMipmaps      = define_c_func(glu32,"gluBuild2DMipmaps",{C_INT,C_INT,C_INT,C_INT,C_INT,C_INT,C_PTR},C_INT),
xgluCylinder            = define_c_proc(glu32,"gluCylinder",{GLUquadricPtr,C_DOUBLE,C_DOUBLE,C_DOUBLE,C_INT,C_INT}),
xgluDeleteNurbsRenderer = define_c_proc(glu32,"gluDeleteNurbsRenderer",{GLUnurbsPtr}),
xgluDeleteQuadric       = define_c_proc(glu32,"gluDeleteQuadric",{GLUquadricPtr}),
xgluDeleteTess          = define_c_proc(glu32,"gluDeleteTess",{C_PTR}),
xgluDisk                = define_c_proc(glu32,"gluDisk",{GLUquadricPtr,C_DOUBLE,C_DOUBLE,C_INT,C_INT}),
xgluEndCurve            = define_c_proc(glu32,"gluEndCurve",{GLUnurbsPtr}),
xgluEndPolygon          = define_c_proc(glu32,"gluEndPolygon",{GLUtesselatorPtr}),
xgluEndSurface          = define_c_proc(glu32,"gluEndSurface",{GLUnurbsPtr}),
xgluEndTrim             = define_c_proc(glu32,"gluEndTrim",{GLUnurbsPtr}),
xgluLookAt              = define_c_proc(glu32,"gluLookAt",repeat(C_DOUBLE,9)),
xgluNewNurbsRenderer    = define_c_func(glu32,"gluNewNurbsRenderer",{},GLUnurbsPtr),
xgluNewQuadric          = define_c_func(glu32,"gluNewQuadric",{},GLUquadricPtr),
xgluNewTess             = define_c_func(glu32,"gluNewTess",{},C_PTR),
xgluNurbsProperty       = define_c_proc(glu32,"gluNurbsProperty",{GLUnurbsPtr,C_INT,C_FLOAT}),
xgluNurbsSurface        = define_c_proc(glu32,"gluNurbsSurface",{GLUnurbsPtr,C_INT,C_PTR,C_INT,C_PTR,C_INT,C_INT,C_PTR,C_INT,C_INT,C_INT}),
xgluPerspective         = define_c_proc(glu32,"gluPerspective",{C_DOUBLE,C_DOUBLE,C_DOUBLE,C_DOUBLE}),
xgluProject             = define_c_func(glu32,"gluProject",{C_DOUBLE,C_DOUBLE,C_DOUBLE,C_PTR,C_PTR,C_PTR,C_PTR,C_PTR,C_PTR},C_INT),
xgluPwlCurve            = define_c_proc(glu32,"gluPwlCurve",{GLUnurbsPtr,C_INT,C_PTR,C_INT,C_INT}),
xgluQuadricDrawStyle    = define_c_proc(glu32,"gluQuadricDrawStyle",{GLUquadricPtr,C_INT}),
xgluQuadricNormals      = define_c_proc(glu32,"gluQuadricNormals",{GLUquadricPtr, C_INT}),
xgluQuadricOrientation  = define_c_proc(glu32,"gluQuadricOrientation",{GLUquadricPtr,C_INT}),
xgluQuadricTexture      = define_c_proc(glu32,"gluQuadricTexture",{GLUquadricPtr, C_INT}),
xgluScaleImage          = define_c_func(glu32,"gluScaleImage",{C_INT, C_INT, C_INT, C_INT, C_PTR, C_INT, C_INT, C_INT, C_PTR},C_INT),
xgluSphere              = define_c_proc(glu32,"gluSphere",{GLUquadricPtr,C_DOUBLE,C_INT,C_INT}),
xgluTessBeginContour    = define_c_proc(glu32,"gluTessBeginContour",{C_PTR}),
xgluTessBeginPolygon    = define_c_proc(glu32,"gluTessBeginPolygon",{C_PTR,C_PTR}),
xgluTessCallback        = define_c_proc(glu32,"gluTessCallback",{C_PTR,C_INT,C_PTR}),
xgluTessEndContour      = define_c_proc(glu32,"gluTessEndContour",{C_PTR}),
xgluTessEndPolygon      = define_c_proc(glu32,"gluTessEndPolygon",{C_PTR}),
xgluTessNormal          = define_c_proc(glu32,"gluTessNormal",{C_PTR,C_DOUBLE,C_DOUBLE,C_DOUBLE}),
xgluTessProperty        = define_c_proc(glu32,"gluTessProperty",{C_PTR,C_INT,C_DOUBLE}),
xgluTessVertex          = define_c_proc(glu32,"gluTessVertex",{C_PTR,C_PTR,C_PTR}),
xgluUnProject           = define_c_func(glu32,"gluUnProject",{C_DOUBLE,C_DOUBLE,C_DOUBLE,C_PTR,C_PTR,C_PTR,C_PTR,C_PTR,C_PTR},C_INT)
