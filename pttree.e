...
global constant T_withpop       = 5968  tt_stringF("withpop",T_withpop)
global constant T_r0            = 5976  tt_stringF("r0",T_r0)
global constant T_r1            = 5980  tt_stringF("r1",T_r1)
global constant T_r2            = 5988  tt_stringF("r2",T_r2)
global constant T_r3            = 5996  tt_stringF("r3",T_r3)
global constant T_r4            = 6004  tt_stringF("r4",T_r4)
global constant T_r5            = 6012  tt_stringF("r5",T_r5)
global constant T_r6            = 6020  tt_stringF("r6",T_r6)
global constant T_r7            = 6028  tt_stringF("r7",T_r7)
--erm, oh dear...
--global constant T_r8          = 6088  tt_stringF("r8",T_r8)
--global constant T_r9          = 6088  tt_stringF("r9",T_r9)
--global constant T_r10         = 6088  tt_stringF("r10",T_r10)
global constant T_fp            = 6032  tt_stringF("fp",T_fp)
global constant T_ip            = 6040  tt_stringF("ip",T_ip)
----global constant T_sp        = 6088  tt_stringF("sp",T_sp)
global constant T_lr            = 6048  tt_stringF("lr",T_lr)
