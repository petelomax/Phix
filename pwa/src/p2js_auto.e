...
--
global constant last_built = "February 17 2022 10:28:54am"
...
global constant p2js_auto = {{`decode_base64`, `Func`, `FP`, `base64.e`},
                             ...
                             {`push`, `Proc`, `PIOII`, `pqueue.e`},
                             {`pushn`, `Proc`, `PIPI`, `pqueue.e`},
                             {`queue_empty`, `Func`, `FI`, `pqueue.e`},
                             {`queue_size`, `Func`, `FI`, `pqueue.e`},
                             {`top`, `Func`, `FII`, `pqueue.e`},
                             {`topn`, `Func`, `FIII`, `pqueue.e`},
