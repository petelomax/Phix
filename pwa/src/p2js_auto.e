...
global constant p2js_auto = {{`decode_base64`, `Func`, `FP`, `base64.e`},
                             ...
                             {`begins`, `Func`, `FOPI`, `match.e`},
                             {`ends`, `Func`, `FOPI`, `match.e`},
                             ...
                             {`find_any`, `Func`, `FPPII`, `pfindany.e`},
                             {`match_any`, `Func`, `FPPII`, `pfindany.e`},
                             ...
                             {`maxsq`, `Func`, `FPII`, `pmaths.e`},
                             {`median`, `Func`, `FP`, `pmaths.e`},
                             {`min`, `Func`, `FOO`, `pmaths.e`},
                             {`minsq`, `Func`, `FPII`, `pmaths.e`},
                             ...
                             {`average`, `Func`, `FOO`, `psum.e`},
                             {`product`, `Func`, `FOO`, `psum.e`},
                             {`std_dev`, `Func`, `FOO`, `psum.e`},
                             {`sum`, `Func`, `FOO`, `psum.e`},
                             ...
                             {`add_member`, `Func`, `FOO`, `sets.e`},
                             {`add_members`, `Func`, `FOP`, `sets.e`},
                             {`difference`, `Func`, `FOOIN`, `sets.e`},
                             {`discard_set`, `Proc`, `PO`, `sets.e`},
                             {`get_management`, `Func`, `F`, `sets.e`},
                             {`get_members`, `Func`, `FOI`, `sets.e`},
                             {`intersection`, `Func`, `FOON`, `sets.e`},
                             {`is_empty`, `Func`, `FO`, `sets.e`},
                             {`is_member`, `Func`, `FOO`, `sets.e`},
                             {`is_subset`, `Func`, `FOO`, `sets.e`},
                             {`is_superset`, `Func`, `FOO`, `sets.e`},
                             {`new_set`, `Func`, `FO`, `sets.e`},
                             {`remove_member`, `Func`, `FOO`, `sets.e`},
                             {`remove_members`, `Func`, `FOP`, `sets.e`},
                             {`set_ignore_atom`, `Proc`, `PO`, `sets.e`},
                             {`set_management`, `Proc`, `PSI`, `sets.e`},
                             {`set_size`, `Func`, `FO`, `sets.e`},
                             {`union`, `Func`, `FOON`, `sets.e`},
                             ...
                             {`get_tests_failed`, `Func`, `F`, `unit_test.e`},
...
global constant p2js_alia = {{`destroy_stack`, `destroy_queue`},
                             ...
                             {`get_set_management`, `get_management`},
                             {`hcf`, `gcd`},
