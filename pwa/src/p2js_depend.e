...
{{`assert.e`,
 ...
 {`dict.e`,
  ...
  {{`KEY`, `DATA`, `LEFT`, `HEIGHT`, `RIGHT`, `trees`, `treenames`, `roots`, `sizes`, `defaults`, `freelists`, `free_trees`,
    ...
    `getNode`, `getKey`, `minValueNode`, `deleteNode`, `traverse`, `traverse_key`, `traverser`, `peekpop`, `new_dicts`,
    `destroy_dictf`}},
  {{`deld`, {{`key`, `?`}, {`tid`, `1`}}},
 ...
 {`xpGUI.e`,
  ...
  {{`crash`, {{`msg`, `?`}, {`args`, `{}`}, {`nFrames`, `1`}}},
   {`gCanvasCircle`,
    {{`canvas`, `?`}, {`xc`, `?`}, {`yc`, `?`}, {`radius`, `?`}, {`filled`, `false`}, {`style`, `-1`}, {`width`, `-1`},
     {`colour`, `-1`}, {`fillcolour`, `-1`}}},
   {`gCanvasLine`,
    {{`canvas`, `?`}, {`x1`, `?`}, {`y1`, `?`}, {`x2`, `?`}, {`y2`, `?`}, {`style`, `-1`}, {`width`, `-1`}, {`colour`, `-1`}}},
   {`gCanvasPolygon`,
    {{`canvas`, `?`}, {`poly`, `?`}, {`bFilled`, `true`}, {`colour`, `-1`}, {`style`, `-1`}, {`width`, `-1`}, {`angle`, `0`}}},
   {`gCanvasRect`,
    {{`canvas`, `?`}, {`xmin`, `?`}, {`xmax`, `?`}, {`ymin`, `?`}, {`ymax`, `?`}, {`bFill`, `false`}, {`rc`, `0`},
     {`style`, `-1`}, {`width`, `-1`}, {`colour`, `-1`}, {`fillcolour`, `-1`}}},
   {`gCanvasText`,
    {{`canvas`, `?`}, {`x`, `?`}, {`y`, `?`}, {`text`, `?`}, {`align`, `XPG_E`}, {`angle`, `0`}, {`colour`, `-1`},
     {`style`, `-1`}}},
 ...
 {`unit_test.e`,
  ...
  {{`tests_run`, `tests_passed`, `tests_failed`, `verbosity`, `abort_on_fail`, `pause_summary`, `log_fn`, `module`, `prev_module`,
    `test_log`, `show_module`, `sn2`, `test_result`, `rec_equal`, `bool_or_string`}},
