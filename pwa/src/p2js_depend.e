...
{{`assert.e`,
 ...
 {`dict.e`,
  ...
  {{`KEY`, `DATA`, `LEFT`, `HEIGHT`, `RIGHT`, `trees`, `treenames`, `roots`, `sizes`, `defaults`, `freelists`, `free_trees`,
    `init_dict`, `dict_init`, `check_tid`, `newNode`, `height`, `setHeight`, `rotate`, `getBalance`, `insertNode`, `getNode`,
    `getKey`, `minValueNode`, `deleteNode`, `traverse`, `traverse_key`, `traverser`, `peekpop`}},
  {{`deld`, {{`key`, `?`}, {`tid`, `1`}}},
 ...
 {`mpfr.e`,
  {{`find.e`, `pmaths.e`, `primes.e`, `ptagset.e`, `mpfr.e`}},
  {{}},
  {{`mpz_get_str`, {{`x`, `?`}, {`base`, `10`}, {`comma_fill`, `false`}}}}},
 {`ordinal.e`,
  {{`find.e`, `ptagset.e`, `pcolumn.e`, `pmaths.e`}},
 ...
 {`pqueue.e`,
  ...
  {{`PDATA`, `PRIORITY`, `pqinit`, `pq`, `pqtype`, `pqcrid`, `freelist`, `pq_compare`, `pq_init`, `q_init`, `q`, `qtypes`,
    `qfreelist`, `new_queue`, `new_stack`, `destroy_queue`, `queue_size`, `queue_empty`, `pushn`, `pop`, `popn`, `top`, `topn`}},
  {{`pq_add`, {{`item`, `?`}, {`pqid`, `1`}}},
   ...
   {`pq_pop_data`, {{`pqid`, `1`}}},
   {`pq_size`, {{`pqid`, `1`}}},
   {`push`, {{`qid`, `?`}, {`item`, `?`}, {`qtype`, `ANY_QUEUE`}, {`bSingle`, `true`}}},
   {`new_queue`, {{`qtype`, `FIFO_QUEUE`}}},
   {`new_stack`, {{`qtype`, `LIFO_QUEUE`}}},
   {`destroy_queue`, {{`qid`, `?`}}},
   {`queue_size`, {{`qid`, `?`}}},
   {`queue_empty`, {{`qid`, `?`}}},
   {`pushn`, {{`qid`, `?`}, {`items`, `?`}, {`qtype`, `ANY_QUEUE`}}},
   {`pop`, {{`qid`, `?`}, {`n`, `-1`}, {`qtype`, `ANY_QUEUE`}, {`bPop`, `true`}}},
   {`popn`, {{`qid`, `?`}, {`n`, `?`}, {`qtype`, `ANY_QUEUE`}}},
   {`top`, {{`qid`, `?`}, {`n`, `-1`}, {`qtype`, `ANY_QUEUE`}}},
   {`topn`, {{`qid`, `?`}, {`n`, `?`}, {`qtype`, `ANY_QUEUE`}}}}},
 {`premoveall.e`,
  {{`find.e`}},
  {{}},
