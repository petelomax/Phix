...
{{`assert.e`,
 ...
 {`xpGUI.e`,
  ...
  {{}},
  {{`crash`, {{`msg`, `?`}, {`args`, `{}`}, {`nFrames`, `1`}}},
   {`gCanvasCircle`, {{`canvas`, `?`}, {`xc`, `?`}, {`yc`, `?`}, {`radius`, `?`}, {`filled`, `false`}, 
                    {`style`, `-1`}, {`width`, `-1`}, {`colour`, `-1`}, {`fillcolour`, `-1`}}},
   {`gCanvasLine`, {{`canvas`, `?`}, {`x1`, `?`}, {`y1`, `?`}, {`x2`, `?`}, {`y2`, `?`}, 
                    {`style`, `-1`}, {`width`, `-1`}, {`colour`, `-1`}}},
   {`gCanvasRect`, {{`canvas`, `?`}, {`xmin`, `?`}, {`xmax`, `?`}, {`ymin`, `?`}, {`ymax`, `?`}, 
                    {`bFill`, `false`}, {`rc`, `0`}, {`style`, `-1`}, {`width`, `-1`}, 
                    {`colour`, `-1`}, {`fillcolour`, `-1`}}},
   {`gCanvasText`, {{`canvas`, `?`}, {`x`, `?`}, {`y`, `?`}, {`text`, `?`}, {`align`, `XPG_E`}, 
                    {`angle`, `0`}, {`colour`, `-1`}, {`style`, `-1`}}},
