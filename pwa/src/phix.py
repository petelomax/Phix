for phix.py... [DEV]
    types = (
        ...
        'cdCanvan', 'cdCanvas', 'complex', 'CURLcode', 'int', 'integer',
        'Ihandle', 'Ihandles', 'Ihandln', 'mpfr', 'mpq', 'mpz', 'mpz_or_string',
        'number', 'rid_string', 'seq', 'sequence', 'timedate', 'object'
    )
    keywords = (
    ...
    routines = (
        ...
        'from_polar', 'gcd', 'get_file_base', 'get_file_extension',
        'get_file_name', 'get_file_name_and_path', 'get_file_path',
        'get_file_path_and_name', 'get_maxprime', 'get_prime', 'get_primes',
        'get_primes_le', 'get_proper_dir', 'get_proper_path', 'get_rand',
        'get_routine_info', 'get_test_abort', 'get_test_logfile',
        ...
        'glVertexAttribPointer', 'glViewport', 'gMainLoop', 'gMainLoopf', 'hcf',
        ...
        'largest', 'lcm', 'length', 'ln', 'log', 'log10', 'log2', 'lower',
        ...
        'match_replace', 'max', 'maxsq', 'min', 'minsq', 'mod', 'mpfr_abs',
        'mpfr_add', 'mpfr_add_d', 'mpfr_add_si', 'mpfr_ceil', 'mpfr_cmp',
        'mpfr_cmp_si', 'mpfr_const_pi', 'mpfr_div', 'mpfr_div_d', 'mpfr_div_si',
        'mpfr_div_z', 'mpfr_floor', 'mpfr_free', 'mpfr_get_d',
        ...
        'mpfr_mul', 'mpfr_mul_d', 'mpfr_mul_si', 'mpfr_mul_z', 'mpfr_neg',
        ...
        'mpfr_ui_pow_ui', 'mpq_abs', 'mpq_add', 'mpq_add_si',
        ...
        'mpz_nthroot', 'mpz_odd', 'mpz_pollard_rho', 'mpz_popcount',
        'mpz_pow_ui', 'mpz_powm', 'mpz_powm_ui', 'mpz_prime', 'mpz_factors',
        'mpz_prime_factors', 'mpz_rand', 'mpz_rand_ui', 'mpz_re_compose',
        'mpz_remove', 'mpz_scan0', 'mpz_scan1', 'mpz_set', 'mpz_set_d',
        'mpz_set_si', 'mpz_set_str', 'mpz_set_v', 'mpz_sign', 'mpz_sizeinbase',
        'mpz_sqrt', 'mpz_sub', 'mpz_sub_si', 'mpz_sub_ui', 'mpz_si_sub',
        'mpz_tdiv_q_2exp', 'mpz_tdiv_r_2exp', 'mpz_tstbit', 'mpz_ui_pow_ui',
        'mpz_xor', 'mulmod', 'named_dict', 'new_dict', 'new_queue', 'new_stack',
        ...
        'peep_dict', 'permute', 'permutes', 'platform', 'pop', 'popn',
    ...
    constants = (
        ...
        'VC_SCRNCOLS', 'WHITE', 'WINDOWS', 'YELLOW'
    )
