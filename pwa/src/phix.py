for phix.py... [DEV]
    ...
    keywords = (
        'and', 'break', 'by', 'case', 'catch', 'const', 'constant', 'default',
        'do', 'else', 'elsif', 'end', 'enum', 'exit', 'fallthru', 'fallthrough',
        'for', 'forward', 'function', 'global', 'if', 'iff', 'iif', 'in',
        'include', 'js', 'javascript', 'javascript_semantics', 'let', 'not',
        'or', 'procedure', 'return', 'safe_mode', 'switch', 'then', 'to', 'try',
    ...
    supported routines = (
        ...
        'glVertexAttribPointer', 'glViewport', 'head', 'hsv_to_rgb',
        'include_file', 'incl0de_file', 'insert', 'instance', 'int_to_bits',
        'int_to_bytes', 'is_dict', 'is_integer', 's_leap_year', 'is_prime',
        'is_prime2', 'islower', 'isupper', 'Icallback', 'iup_isdouble',
    ...
    unsupported routines = (
        ...
        'check_break', 'clearDib', 'close', 'closesocket', 'copy_file',
        ...
        'define_c_proc', 'delete', 'delete_cs', 'delete_file', 'dir', 'DLL',
        'drawDib', 'drawShadedPolygonToDib', 'ELF32', 'ELF64', 'enter_cs',
        'eval', 'exit_thread', 'free', 'file_exists', 'final',
