...
//              case 'd','x','o','b':   ftyp = INTEGER
                ...
                case 0X66: case 0X67: case 0X65: ftyp = $ATOM;
                    break;
                case 0X72: ftyp = (($scan_ch===0X52) ? $ROMAN : $ROMAL);
                    break;
...
//              if $scan_ch='\'' and s[sidx]=N and s[sidx+2]='\'' then
                if (((($scan_ch===0X27) && (scan_ch2===N)) && compare(sidx,length(s))<0) && (equal($subse(s,sidx+1),0X27))) {
                    sidx += 2;
                    return ["sequence",N*msign,sidx];
                }
                scan_ch2 = 0X2E;
...
//              tries = 0
            ...
            res = resset;
        } else if ((equal(ffi,$ROMAN)) || (equal(ffi,$ROMAL))) {
