...
// [[UTC-06:00]] ([[Gal�pagos Time|GALT]]) � [[Gal�pagos Province, Ecuador|Gal�pagos Province]]
...
//Google Translate:
//$months[de] = {"Januar","Februar","M�rz","April","Mai","Juni","Juli",
...
//$day_names[es] = {"Domingo","Lunes","Martes","Mi�rcoles","Jueves","Viernes","S�bado"}
//$months[fi] = {"Tammikuu","Helmikuu","Maaliskuu","Huhtikuu","Toukokuu","Kes�kuu",
//              "Hein�kuu","Elokuu","Syyskuu","Lokakuu","Marraskuu","Joulukuu"}
//$day_names[fi] = {"maanantai","tiistai","keskiviikko","torstai","perjantai","lauantai"}
//$months[fr] = {"Janvier","F�vrier","Mars","Avril","Mai","Juin","Juillet",
...
//$day_names[it] = {"domenica","luned�","marted�","mercoled�","gioved�","venerd�","sabato
...
//$months[pt] = {"Janeiro","Fevereiro","Mar�o","Abril","Maio","Junho","Julho",
//              "Agosto","Setembro","Outubro","Novembro","Dezembro"}
//$day_names[pt] = {"domingo","segunda","ter�a","quarta","quinta","sexta","s�bado"}
...
//
    let /*string*/ fmti; // (gives an earlier/better typecheck and thus simplifies debugging)
