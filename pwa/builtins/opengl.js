...
// Note that IupGLMakeCurrent() as you might expect lives in pGUI.js, but
//   therefore so too does $gl even though it is only really used in here.


function glSimpleA7texcoords(/*integer*/ faces) {
